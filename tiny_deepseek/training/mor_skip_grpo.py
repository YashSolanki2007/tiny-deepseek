...
from tiny_deepseek.core.losses import clipped_grpo_loss_per_decision, grpo_reward, group_relative_advantages
from tiny_deepseek.core.model import MixtureOfRecursionsSkipLayerTransformer
from tiny_deepseek.training.mor_skip import (
    add_hybrid_flops,
    add_router_fields,
    metric_fields,
)
...
def main() -> None:
    ...
    experiment_dir = Path(
        args.experiment_dir
        or f"artifacts/experiments/{supervised_dir.name}_grpo_lam{args.lambda_compute_grpo:g}_seed{args.seed}"
    )

...
from tiny_deepseek.core.config import ModelConfig, TrainConfig
...
from tiny_deepseek.core.model import TransformerBase, build_model
...
def main() -> None:
    ...
    experiment_dir = Path(args.experiment_dir or f"artifacts/experiments/{default_name}")

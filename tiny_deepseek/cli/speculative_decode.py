...
from tiny_deepseek.cli.generate import generate_tokens
from tiny_deepseek.core.model import SparseMoEMTPTransformer
from tiny_deepseek.core.utils import load_checkpoint, select_device, set_seed, synchronize_device, write_json
...
def main() -> None:
    ...
    parser.add_argument(
        "--checkpoint",
        default=(
            "artifacts/experiments/skiplayer_moe_mtp_mla_rope_seed42/"
            "grpo/checkpoints/best_quality_compute.pt"
        ),
    )
    parser.add_argument("--data-path", default="data/input.txt")
    parser.add_argument("--output-dir", default="artifacts/results/speculative_mla_rope_seed42")

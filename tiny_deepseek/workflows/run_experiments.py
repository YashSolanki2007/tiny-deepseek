...
def main() -> None:
    ...
    for seed in args.seeds:
        ...
        if not completed(dense_dir, args.force):
            ...
            run([
                sys.executable, "-m", "tiny_deepseek.training.supervised", "--model", "dense",
            ...
            for lambda_density in lambda_densities:
                ...
                for router in ("linear", "gru"):
                    ...
                    if not completed(experiment, args.force):
                        ...
                        run([
                            sys.executable, "-m", "tiny_deepseek.training.supervised", "--model", "sparse",
                ...
                for grpo_lambda in grpo_lambdas:
                    ...
                    run([
                        sys.executable, "-m", "tiny_deepseek.training.routing_grpo", "--checkpoint", str(checkpoint),

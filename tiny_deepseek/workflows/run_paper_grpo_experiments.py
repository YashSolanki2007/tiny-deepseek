...
def main() -> None:
    ...
    parser.add_argument(
        "--experiments-dir", default="artifacts/experiments/paper_core_scaled_lr001_1000"
    )
    parser.add_argument("--results-dir", default="artifacts/results/paper_grpo_seed42")
    ...
    for lam in args.lambdas:
        ...
        command = [
            sys.executable,
            "-m", "tiny_deepseek.training.paper_grpo",
    ...
    run(
        [
            sys.executable,
            "-m", "tiny_deepseek.workflows.generate_report",
            "--experiments-dir", str(experiments_dir),

...
from tiny_deepseek.training.math_utils import evaluate_math_answers, evaluate_math_model
from tiny_deepseek.core.model import SparseMoEMTPTransformer
from tiny_deepseek.core.utils import load_checkpoint, select_device, write_json
...
def main() -> None:
    ...
    parser.add_argument(
        "--checkpoint",
        default="artifacts/experiments/math_v2_seed42/grpo/checkpoints/latest.pt",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--supervised-dir", default="artifacts/experiments/math_v2_seed42/supervised"
    )
    parser.add_argument("--grpo-dir", default="artifacts/experiments/math_v2_seed42/grpo")

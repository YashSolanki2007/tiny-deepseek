...
def main() -> None:
    ...
    parser.add_argument("--experiments-dir", default="experiments/paper_core")
    parser.add_argument("--results-dir", default="results/paper_core")
    ...
    for seed in args.seeds:
        ...
        if not skip:
            run([
                sys.executable, str(root / "train.py"), "--paper-reproduction",

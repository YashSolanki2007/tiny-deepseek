...
from losses import masked_density_loss
from model import MixtureOfRecursionsSkipLayerTransformer, build_model
from utils import (
...
def main() -> None:
    ...
    experiment_dir = Path(
        args.experiment_dir
        or f"experiments/{source_dir.name}_inner_skip_P{int(100*args.target_skip_density):03d}_seed{args.seed}"
    )
